    ...
    */
    ...
    'components' => [
        ...
        */
        ...
        // Nulled so the application's own <x-icon> component owns that name;
        // it wraps heroicons with a safe fallback for unknown names.
        // Icons remain reachable via @svg() and <x-heroicon-*>.
        'default' => null,
